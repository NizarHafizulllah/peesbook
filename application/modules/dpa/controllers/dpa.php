...
class dpa extends admin_controller {
    ...
    $config['upload_path'] = './assets/file_upload/dpa';
    ...
    function baru(){
        ...
        $this->set_subtitle("Tambah DPA");
        $this->set_title("Tambah DPA");
        $this->set_content($content);
        $this->cetak();
}
    ...
    function lihatdata(){
        ...
        $this->set_subtitle("Lihat Data DPA");
        $this->set_title("Lihat Data DPA");
        $this->set_content($content);
        $this->cetak();
      ...
      function hapusdata(){
        ...
        $this->db->where('id', $id);
        $dpa = $this->db->get('dpa')->row_array();
        $path = 'assets/file_upload/dpa/'.$dpa['dir'];
