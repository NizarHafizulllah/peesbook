...
class tor extends admin_controller {
    ...
    $config['upload_path'] = './assets/file_upload/tor';
    ...
    function baru(){
        ...
        $this->set_subtitle("Tambah TOR");
        $this->set_title("Tambah TOR");
        $this->set_content($content);
        $this->cetak();
}
    ...
    function lihatdata(){
        ...
        $this->set_subtitle("Lihat Data TOR");
        $this->set_title("Lihat Data TOR");
        $this->set_content($content);
        $this->cetak();
      ...
      function hapusdata(){
        ...
        $this->db->where('id', $id);
        $tor = $this->db->get('tor')->row_array();
        $path = 'assets/file_upload/tor/'.$tor['dir'];
