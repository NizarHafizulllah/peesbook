...
class kas extends admin_controller {
    ...
    $config['upload_path'] = './assets/file_upload/kas';
    ...
    function lihatdata(){
        ...
        $this->set_subtitle("Lihat Data KAS");
        $this->set_title("Lihat Data KAS");
        $this->set_content($content);
        $this->cetak();
      ...
      function hapusdata(){
        ...
        $path = 'assets/file_upload/kas/'.$kas['dir'];
